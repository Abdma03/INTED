...
% colors
\definecolor{mydarkblue}{RGB}{43, 45, 66}
\definecolor{myblue}{RGB}{141, 153, 174}
\definecolor{mywhite}{RGB}{237, 242, 244}
...
\input{Rapport/introduksjon} % introduction to the report. 
\input{Rapport/bakgrunn} % background of article or theory
\input{Rapport/metode} % methodology
\input{Rapport/resultater} % elaborating on the results
\input{Rapport/diskusjon} % analyse the data. Can be combined with the results section to form one combined section. 
\input{Rapport/konklusjon}
